...
![Diagrama detallado de contenidos fundamentales para el desarrollo del curso](pics/img_01.png)
...
![Elaboración de un boxplot o diagrama de caja](pics/img_05.png)
