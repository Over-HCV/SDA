...
poblar_artefactos_preparacion <- function() {
  ...
  registrar_artefacto("f1.diccionario.tabla", "Diccionario de columnas",
    ...
    logica  = "R/logica/datos/diccionario.R::avisos_diccionario",
  ...
  registrar_artefacto("f1.calidad.matriz_nulidad", "Matriz de nulidad",
    grafico = "R/graficos/calidad.R::graficar_nulidad",
    logica  = "R/logica/datos/calidad.R::patron_faltantes",
  ...
  registrar_artefacto("f1.calidad.atipicos", "Atípicos detectados",
    grafico = "R/graficos/calidad.R::graficar_atipicos",
    logica  = "R/logica/datos/calidad.R::detectar_atipicos",
  ...
  registrar_artefacto("f1.calidad.duplicados", "Filas duplicadas",
    ...
    logica  = "R/logica/datos/calidad.R::marcar_duplicados",
  ...
  registrar_artefacto("f1.transformacion.antes_despues", "Antes y después",
    grafico = "R/graficos/preparacion.R::graficar_antes_despues",
    logica  = "R/logica/datos/transformacion.R::aplicar_transformaciones",
  ...
  registrar_artefacto("f1.transformacion.perfil_boxcox", "Perfil de lambda (Box-Cox)",
    grafico = "R/graficos/preparacion.R::graficar_perfil_boxcox",
    logica  = "R/logica/datos/transformacion.R::perfil_boxcox",
  ...
  registrar_artefacto("f1.particion.tamanos", "Tamaño de cada parte",
    grafico = "R/graficos/preparacion.R::graficar_particion",
    logica  = "R/logica/datos/particion.R::resumir_particion",
  ...
  registrar_artefacto("f1.particion.balance", "Balance por partición",
    grafico = "R/graficos/preparacion.R::graficar_balance_particion",
    logica  = "R/logica/datos/particion.R::balance_por_particion",
  ...
  registrar_artefacto("f1.balanceo.frecuencias", "Frecuencias por clase",
    grafico = "R/graficos/calidad.R::graficar_balance",
    logica  = "R/logica/datos/balanceo.R::resumir_balance",
  ...
  registrar_artefacto("f1.balanceo.nube_sinteticos", "Nube con filas remuestreadas",
    grafico = "R/graficos/preparacion.R::graficar_nube_sinteticos",
    logica  = "R/logica/datos/balanceo.R::balancear",
